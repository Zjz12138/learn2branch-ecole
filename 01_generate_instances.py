...
if __name__ == '__main__':
    ...
    if args.problem == 'setcover':
        ...
        # train instances
        generate_setcovers(1000, "train", nrows, ncols, dens, rng)
        #
        ...
        # train instances
        generate_indsets(1000, "train", number_of_nodes, affinity, rng)
        ...
        # train instances
        generate_cauctions(1000, "train", number_of_items, number_of_bids, rng=rng)
        #
        # # validation instances
        ...
        # train instances
        generate_facilities(1000, "train", number_of_customers, number_of_facilities, ratio, rng)
        #
        # # validation instances
